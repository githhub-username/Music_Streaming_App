...
class SongsListAdapter(private val songIdList: List<String>):
    ...
    class MyViewHolder(private val binding: ItemSongsRecyclerViewBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = ItemSongsRecyclerViewBinding.inflate(LayoutInflater.from(parent.context),parent,false)
